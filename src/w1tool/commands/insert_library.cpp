...
int insert_library(
    ...
    log.info(
        "insert library starting", 
        redlog::field("dylib_path", cfg.library_path),
        redlog::field("binary_path", cfg.target_binary),
        redlog::field("in_place", cfg.in_place),
        redlog::field("weak_import", cfg.weak_import),
        redlog::field("overwrite_existing", cfg.overwrite_existing),
        redlog::field("strip_code_signature", cfg.strip_code_signature),
        redlog::field("assume_yes", cfg.assume_yes)
    );
    ...
    if (result.success()) {
        ...
        log.err("library import insertion failed", 
