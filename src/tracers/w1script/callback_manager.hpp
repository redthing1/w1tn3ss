...
public:
    ...
    void set_api_analysis_components(
        api_analysis_processor* api_processor,
        bindings::api_analysis_manager* api_manager,
        w1::util::module_range_index* module_index,
        w1::symbols::symbol_resolver* symbol_resolver
    ) {
     ...
     */
    const std::vector<uint32_t>& get_registered_ids() const {
        return registered_callback_ids_;
    }
