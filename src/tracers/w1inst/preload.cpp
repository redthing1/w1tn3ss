...
static std::unique_ptr<w1::trace_session<w1inst::instruction_tracer>> g_session;
...
QBDI_EXPORT int qbdipreload_on_run(QBDI::VMInstanceRef vm, QBDI::rword start, QBDI::rword stop) {
  ...
  g_session =
      std::make_unique<w1::trace_session<w1inst::instruction_tracer>>(session_config, vm, std::in_place, g_config);
