...
public:
    ...
    template<typename T>
    static std::optional<T> read(QBDI::VMInstanceRef vm, uint64_t address) {
    ...
    template<typename T>
    static std::optional<std::vector<T>> read_array(
    ...
    static std::optional<std::wstring> read_wstring(
        QBDI::VMInstanceRef vm,
        uint64_t address,
        size_t max_length = 256);
    ...
    template<typename T>
    static std::optional<T> read_struct(
        QBDI::VMInstanceRef vm,
        uint64_t address) {
    ...
    static std::vector<bool> read_batch(
        QBDI::VMInstanceRef vm,
