...
static const std::vector<api_info> macos_libcxx_apis = {
    ...
    {.name = "___cxa_throw",
     ...
     .parameters =
         {{.name = "thrown_object", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::IN},
    ...
    {.name = "___cxa_guard_acquire",
     ...
     .convention = MACOS_API_CONVENTION,
     .parameters =
         {{.name = "guard_object", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::IN_OUT}},
    ...
    {.name = "___dynamic_cast",
     ...
     .parameters =
         {{.name = "src_ptr", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::IN},
          ...
          {.name = "src2dst_offset", .param_type = param_info::type::INTEGER, .param_direction = param_info::direction::IN}},
    ...
    {.name = "___cxa_demangle",
     ...
     .convention = MACOS_API_CONVENTION,
     .parameters =
         {{.name = "mangled_name", .param_type = param_info::type::STRING, .param_direction = param_info::direction::IN},
          {.name = "output_buffer", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::IN_OUT},
    ...
    {.name = "___gxx_personality_v0",
     ...
     .parameters =
         {{.name = "version", .param_type = param_info::type::INTEGER, .param_direction = param_info::direction::IN},
          ...
          {.name = "exception_class", .param_type = param_info::type::INTEGER, .param_direction = param_info::direction::IN},
          {.name = "exception_object", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::IN},
