...
static const std::vector<api_info> windows_psapi_apis = {
    ...
    api_info{
        ...
        .parameters = {
            ...
            {.name = "lpcbNeeded", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::OUT}
        },
    ...
    api_info{
        ...
        .parameters = {
            ...
            {.name = "cb", .param_type = param_info::type::SIZE, .param_direction = param_info::direction::IN},
            {.name = "lpcbNeeded", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::OUT},
            {.name = "dwFilterFlag", .param_type = param_info::type::FLAGS, .param_direction = param_info::direction::IN}
        },
        .return_value = {.name = "success", .param_type = param_info::type::BOOLEAN},
    ...
    api_info{
        ...
        .parameters = {
            ...
            {.name = "lpmodinfo", .param_type = param_info::type::POINTER, .param_direction = param_info::direction::OUT},
            {.name = "cb", .param_type = param_info::type::SIZE, .param_direction = param_info::direction::IN}
        },
        .return_value = {.name = "success", .param_type = param_info::type::BOOLEAN},
