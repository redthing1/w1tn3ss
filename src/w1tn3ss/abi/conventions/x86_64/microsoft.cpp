...
std::vector<uint64_t> x86_64_microsoft::extract_integer_args(
...
x86_64_microsoft::register_info x86_64_microsoft::get_register_info() const {
    return {
        ...
        .callee_saved_fpr = {"xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11", 
...
std::vector<double> x86_64_microsoft::extract_float_args(
    const extraction_context& ctx,
    size_t count) const {
