...
public:
    ...
    std::string get_description() const override {
        return "Microsoft x64 calling convention used on Windows";
    }
...
private:
    // first 4 params use rcx, rdx, r8, r9
    static constexpr std::array<size_t, 4> param_regs = {
