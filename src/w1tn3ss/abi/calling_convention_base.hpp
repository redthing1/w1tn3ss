...
public:
    ...
    virtual std::vector<uint64_t> extract_integer_args(
    ...
    virtual std::vector<typed_arg> extract_typed_args(
        const extraction_context& ctx,
        const std::vector<arg_type>& types) const = 0;
    ...
    virtual typed_arg get_typed_return(
        const QBDI::GPRState* gpr,
        const QBDI::FPRState* fpr,
        arg_type type) const = 0;
    ...
    virtual std::optional<variadic_info> get_variadic_info(
        const extraction_context& ctx,
        size_t fixed_arg_count) const = 0;
    ...
    virtual std::vector<double> extract_float_args(
        const extraction_context& ctx,
        size_t count) const = 0;
};
...
inline std::string to_string(calling_convention_id id) {
    switch (id) {
        case calling_convention_id::UNKNOWN: return "unknown";
        case calling_convention_id::X86_64_SYSTEM_V: return "x86_64_system_v";
        case calling_convention_id::X86_64_MICROSOFT: return "x86_64_microsoft";
        case calling_convention_id::X86_CDECL: return "x86_cdecl";
        case calling_convention_id::X86_STDCALL: return "x86_stdcall";
        case calling_convention_id::X86_FASTCALL: return "x86_fastcall";
        case calling_convention_id::X86_THISCALL: return "x86_thiscall";
        case calling_convention_id::X86_VECTORCALL: return "x86_vectorcall";
        case calling_convention_id::AARCH64_AAPCS: return "aarch64_aapcs";
        case calling_convention_id::AARCH64_WINDOWS: return "aarch64_windows";
        case calling_convention_id::ARM32_AAPCS: return "arm32_aapcs";
        case calling_convention_id::CUSTOM: return "custom";
