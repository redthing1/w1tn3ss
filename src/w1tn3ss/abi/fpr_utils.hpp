...
inline float get_xmm_float(const QBDI::FPRState* fpr, size_t reg_idx) {
  ...
  switch (reg_idx) {
    ...
    case 8: xmm_ptr = fpr->xmm8; break;
    case 9: xmm_ptr = fpr->xmm9; break;
    case 10: xmm_ptr = fpr->xmm10; break;
    case 11: xmm_ptr = fpr->xmm11; break;
    case 12: xmm_ptr = fpr->xmm12; break;
    case 13: xmm_ptr = fpr->xmm13; break;
    case 14: xmm_ptr = fpr->xmm14; break;
    case 15: xmm_ptr = fpr->xmm15; break;
    default: return 0.0f;
  }
