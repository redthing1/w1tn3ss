...
var SIG_DEMO_VERSION = p1.sig(p1.str2hex("DEMO VERSION"), {filter: "p1ll_test_target"});
var SIG_TRIAL_VERSION = p1.sig(p1.str2hex("TRIAL VERSION"), {filter: "p1ll_test_target"});
